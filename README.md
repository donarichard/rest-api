...
```bash
git clone https://github.com/donarichard/nodejs-Rest-Api.git
cd nodejs-Rest-Api
```
...
The app also contains 2 custom mongoose plugins that you can attach to any mongoose model schema. You can find the plugins in `src/plugins`.
